...
files.forEach(function(file) {
  ...
  if (content.includes('googleFirebaseCloudFirestore')) {
    content = content.split('googleFirebaseCloudFirestoreOAuth2Api').join('googleFirebaseCloudFirestoreServiceAccountApi');
